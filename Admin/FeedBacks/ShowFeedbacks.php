    ...
    if (mysqli_num_rows($result) > 0) {
        foreach ($result as $index => $each) {
            ...
            if ($each['customerID'] != null) {
                $stringSQL = "
                    SELECT * FROM `customers` WHERE `customerID` = '" . $each['customerID'] . "'";
            ...
            echo "<tr>";
                ...
                echo "</td>";
                echo "<td class='text-start'>" . ($each['content']) . "</td>";
                        ...
                        <div class='dropdown'>
                            ...
                            <ul class='dropdown-menu'>
                                <li class='d-flex align-items-center'>
                                    <a href='DeleteFeedbacks.php?id=" . $each['id'] . "' class='dropdown-item d-flex align-items-center fs-5'>
